    ...
    private void drawShips(String type, int count){
        for(int i=0;i<count;i++){
            ...
            if(board[coordinateY][coordinateX]!=null){
                ...
                board[coordinateY][coordinateX] = type == "Niszczyciel" ? new Niszczyciel(coordinateY, coordinateX) : type == "Fregata" ? new Fregata(coordinateY, coordinateX) : new Korweta(coordinateY, coordinateX);
            }
